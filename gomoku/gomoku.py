...
class Gomoku(GameBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.action_space = self.width * self.height
    ...
    def graphic(self, player1=1, player2=2):
    ...
    def set_current_player(self, gamer_id):
        self.current_player = gamer_id

    def get_action_space(self):
        return self.action_space

    def is_playing(self):
        is_end, _ = self.game_end()
        return not is_end

    def is_draw(self):
        is_end, winner = self.game_end()
        if is_end and winner == -1:
            return True
        return False
